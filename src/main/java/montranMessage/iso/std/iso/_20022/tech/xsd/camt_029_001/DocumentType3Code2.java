 ...
 * 
 */
@XmlType(name = "DocumentType3Code", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.029.001.08")
@XmlEnum
public enum DocumentType3Code2 {
    ...
    public static DocumentType3Code2 fromValue(String v) {
        return valueOf(v);
    }
